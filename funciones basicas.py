...
"""
n1 = input("digite numero uno: ")
n2 = input("digite numero dos: ")
...
#impresion en interpolacion
print(f'la suma de los numeros {numero_uno} + {numero_dos} es {suma}')

#Haga Un Algoritmo (HUA) que lea un numero y lo eleve al cuadrado
...
# el valor con decuento y el valor ahorrado

valor_inicial = float(input('digite el valor del producto: '))
descuento = valor_inicial * 0.2
valor_final = valor_inicial - descuento

print(f'El valor del producto inicial era {valor_inicial}, el valor del producto con descuento es: {valor_final}, y el valor ahorrado es {descuento}')
